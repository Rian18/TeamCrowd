...
public class Colaborador {
    ...
    public Colaborador(Long idColaborador, String nome, String email, String login, int contribuicao, int numseguidores, int numseguidos, String local, String url, String imagem_URL, Date criado_em) {
        this.idColaborador = idColaborador;
        this.nome = nome;
        this.email = email;
        this.login = login;
